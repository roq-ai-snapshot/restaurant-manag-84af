    ...
    >
      ...
      >
        ...
        <Box flex="1" textAlign="center">
          <Text color="state.info.main" fontSize="0.875rem" fontWeight={600}>
            In order to configure your application visit the console
            <Link href="https://console.roq.tech" style={{ textDecoration: 'none' }} target="_blank">
              <Button
                borderRadius="0.375rem"
                background="state.info.main"
                fontSize="0.75rem"
                fontWeight={600}
                ml="2"
                color="white"
                ...
                _hover={{
                  ...
                  background: 'state.info.transparent',
                }}
              >
                {' '}
                Open console
